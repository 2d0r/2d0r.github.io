    ...
    <main className='z-10 file:flex min-h-screen flex-col items-center bg-gradient-to-b from-blue-500 to-blue-300 overflow-scroll'>
      <div className='relative flex w-screen mt-[25vh]'>
        ...
        <div className='bg-white w-1/3 mt-[12vh] ml-[-10vw] skew-x-0 pt-[6vh] px-[6vh] flex flex-col gap-16'>
          <ProjectSkills projectId='1' onMouseOver={handleOnMouseOver} selected={selectedProject}/>
          <ProjectSkills projectId='2' onMouseOver={handleOnMouseOver} selected={selectedProject}/>
          <ProjectSkills projectId='3' onMouseOver={handleOnMouseOver} selected={selectedProject}/>
          <ProjectSkills projectId='4' onMouseOver={handleOnMouseOver} selected={selectedProject}/>
          <ProjectSkills projectId='5' onMouseOver={handleOnMouseOver} selected={selectedProject}/>
        </div>
      </div>
    </main>
  );
